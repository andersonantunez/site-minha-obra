...
echo.
echo [2/3] Identificando o comando da API...
...
if defined API_SCRIPT (
    ...
    npm.cmd run
    echo.
    echo A WEB foi iniciada em http://localhost:5174/
    echo Verifique qual script deve iniciar a API na porta 3002.
    echo.
)
...
echo.
echo ========================================
echo   AMBIENTE INICIADO PARCIALMENTE
echo ========================================
